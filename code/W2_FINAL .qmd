...
html_document: code_folding: show collapse: no df_print: paged fig_caption: yes fig_height: 6 fig_width: 10 highlight: textmate theme: spacelab toc: yes toc_float: yes editor_options: chunk_output_type: inline ---
...
We definitely have var naming issues, but they look to be the same. Will check again once we have combined together \# Bind rows together
